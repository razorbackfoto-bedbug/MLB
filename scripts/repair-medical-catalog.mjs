...
addBook({
  ...
  amazonProductUrl: 'https://www.amazon.com/dp/1891383094',
  affiliateUrl: null,
...
addBook({
  ...
  amazonProductUrl: 'https://www.amazon.com/dp/B08GB52KZ5',
  affiliateUrl: null,
...
addBook({
  ...
  isbn: '9781739546052',
  publicationYear: 2023,
  amazonProductUrl: 'https://www.amazon.com/dp/B0CMZP9LHP',
  affiliateUrl: null,
  publisherUrl: 'https://theabilitiesinme.com/the-book-titles',
  retailerName: null,
...
addBook({
  slug: 'the-lion-who-had-asthma',
  title: 'The Lion Who Had Asthma',
  coverImage: 'https://covers.openlibrary.org/b/isbn/9780807545607-L.jpg',
  featured: false,
  ...
  format: 'Storybook',
  bookType: 'Storybooks',
  medicalTopics: ['Respiratory', 'Asthma', 'Inhaler', 'Coping & Feelings'],
  siblingFocus: false,
  faithBased: false,
  ageMin: 4,
  ageMax: 8,
  ...
  amazonProductUrl: 'https://www.amazon.com/dp/0807545600',
  affiliateUrl: null,
  publisherUrl: 'https://www.albertwhitman.com/book/the-lion-who-had-asthma/',
  retailerName: null,
  mlbSummary: 'When Sean has an asthma attack during imaginative play, his mother helps him use his inhaler and slow his breathing. The story gives young children a reassuring picture of recognizing symptoms and accepting help.',
  verificationStatus: 'Verified',
  sourceUrl: 'https://childrens.dartmouth-health.org/child-life/websites-and-books',
  notes: 'Recommended by Dartmouth Health Child Life and listed by Children’s Specialized Hospital for ages 4 to 8.',
  sourceCollections: ['MLB respiratory expansion']
});
...
addBook({
  slug: 'i-have-asthma',
  title: 'I Have Asthma',
  coverImage: 'https://covers.openlibrary.org/b/isbn/9780764137853-L.jpg',
  featured: false,
  ...
  amazonProductUrl: 'https://www.amazon.com/dp/0764137859',
  affiliateUrl: null,
  publisherUrl: null,
  retailerName: null,
  mlbSummary: 'A child describes asthma, the worry an attack can cause, and the routines that help keep breathing under control. The approachable story supports calm conversations about medicine, triggers, and asking adults for help.',
  verificationStatus: 'Verified',
  sourceUrl: 'https://www.amazon.com/dp/0764137859',
  notes: 'Title, contributors, edition, and reading age verified through publisher and retailer metadata.',
  sourceCollections: ['MLB respiratory expansion']
});

addBook({
  slug: 'what-happens-when-i-have-asthma',
  title: 'What Happens When I Have Asthma?',
  coverImage: 'https://covers.openlibrary.org/b/isbn/9781499452518-L.jpg',
  featured: false,
  author: 'Emiliya King',
  illustrator: null,
  audience: 'Children & Families',
  ...
  format: 'Educational',
  bookType: 'Educational',
  medicalTopics: ['Respiratory', 'Asthma', 'Inhaler', 'Chronic Illness'],
  siblingFocus: false,
  faithBased: false,
  ageMin: 7,
  ageMax: 10,
  ...
  amazonProductUrl: 'https://www.amazon.com/dp/1499452519',
  affiliateUrl: null,
  publisherUrl: null,
  retailerName: null,
  mlbSummary: 'A concise introduction to what happens in the lungs during asthma, how symptoms may feel, and how children can manage the condition with trusted adults and a care plan.',
  verificationStatus: 'Verified',
  sourceUrl: 'https://www.amazon.com/dp/1499452519',
  notes: 'Paperback ISBN, author, and reading level verified through publisher and retailer metadata.',
  sourceCollections: ['MLB respiratory expansion']
});

addBook({
  slug: 'mallorys-65-roses',
  title: 'Mallory’s 65 Roses',
  coverImage: 'https://covers.openlibrary.org/b/isbn/9780970035301-L.jpg',
  featured: false,
  author: 'Diane Shader Smith',
  illustrator: 'Jay Jackson',
  audience: 'Children & Families',
  audienceTags: ['Children', 'Families'],
  format: 'Storybook',
  bookType: 'Storybooks',
  medicalTopics: ['Respiratory', 'Cystic Fibrosis', 'Genetics', 'Chronic Illness', 'Family Support'],
  siblingFocus: false,
  faithBased: false,
  ageMin: 4,
  ageMax: 8,
  ...
  amazonProductUrl: 'https://www.amazon.com/dp/0970035306',
  affiliateUrl: null,
  publisherUrl: null,
  retailerName: null,
  mlbSummary: 'Mallory explains cystic fibrosis through the child-friendly phrase “65 roses,” sharing how treatments and family support fit into her daily life while keeping the focus on her personality and interests.',
  verificationStatus: 'Verified',
  sourceUrl: 'https://cystic-fibrosis.com/living/childrens-books-cf',
  notes: 'A family-centered cystic fibrosis story with edition details verified through Amazon and ISBN records.',
  sourceCollections: ['MLB respiratory expansion']
});
